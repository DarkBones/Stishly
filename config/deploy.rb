...
set :repository, 'git@github.com:DarkBones/Stishly.git'
set :branch, 'master'
...
set :shared_files, fetch(:shared_files, []).push('config/database.yml', 'config/credentials.yml', 'config/master.key')
